...
class ActivitiesServiceFactory extends Factory {
  static final MemoryPersistenceDescriptor =
      Descriptor('pip-services-activities', 'persistence', 'memory', '*', '1.0');
  ...
  static final MongoDbPersistenceDescriptor =
      Descriptor('pip-services-activities', 'persistence', 'mongodb', '*', '1.0');
  static final ControllerDescriptor =
      Descriptor('pip-services-activities', 'controller', 'default', '*', '1.0');
